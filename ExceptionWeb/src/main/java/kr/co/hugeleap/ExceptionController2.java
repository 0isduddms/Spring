...
public class ExceptionController2 {
	...
	public String ezen3(Model m ) throws Exception {
		throw new NullPointerException("NULLPOINTER 예외가 발생했습니다.");
	}
	
	@RequestMapping("/ex4__")
	public void ezen4(Model m) throws FileNotFoundException {
		throw new FileNotFoundException("파일이 존재하지 않는예외가 발생했습니다.");
	}
	...
	public String catcher(Exception ex, Model m) {
		...
		m.addAttribute("ex", ex);					//예외 정보가 모델에 담겨서 뷰에 전달 된 것
		return "error";
	}
